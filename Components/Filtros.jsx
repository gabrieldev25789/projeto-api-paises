...
function Filtros({ setRegiao, setPopulacao }) {
  ...
  const filtrarPorPop = (valor) => setPopulacao(valor)
    ...
    <div className="filters">
      ...
      <div className="filter-group">
        ...
        <div className="pop-options">
          ...
          filtrarPorPop("")} defaultChecked /> Qualquer tamanho</label>
          <label><input type="radio" name="population" value="lt1m" onClick={() => 
          filtrarPorPop("lt1m")} /> Menos de 1 milhão</label>
          <label><input type="radio" name="population" value="1m-10m" onClick={() => 
          filtrarPorPop("1m-10m")}/> 1 – 10 milhões</label>
          <label><input type="radio" name="population" value="10m-100m" onClick={() => filtrarPorPop("10m-100m")}/> 10 – 100 milhões</label>
          <label><input type="radio" name="population" value="gt100m" onClick={() => 
          filtrarPorPop("gt100m")} /> Mais de 100 milhões</label>
        </div>
      </div>
